...
var MAX_TIMEOUT = 45000;
var BODY_LIMIT = 104857600;
// This is used for testing. A simple mock around bzBond which simply returns
// what it received.
var testBzBond = function(func) {
...
function _routes() {
    _routes = _asyncToGenerator$3(function(fastify, options) {
        return __generator$3(this, function(_state) {
            fastify.post("/function", {
                ...
                if (request.body.arguments) {
                    var argumentString = JSON.stringify(request.body.arguments);
...
var build = /*#__PURE__*/ _asyncToGenerator$2(function(param) {
...
var plugins = /*#__PURE__*/ _asyncToGenerator$1(function() {
...
// Run the server!
var start = /*#__PURE__*/ _asyncToGenerator(function() {
    var app, _tmp, err;
